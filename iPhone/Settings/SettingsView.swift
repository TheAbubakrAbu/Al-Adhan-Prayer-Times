...
struct SettingsView: View {
    ...
    private static let defaultDestination: SettingsDestination = .prayerSettings
    ...
    private var resetSection: some View {
        ...
        Section(header: Text("RESET")) {
            ...
            .confirmationDialog(
                ...
                Text("This restores every setting (appearance and prayer options) to its default. Your bookmarks, favorites, khatm progress, and saved location are kept.")
            }
        }
        #endif
    }
